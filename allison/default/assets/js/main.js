(function($){
	...
	$('.allison-aside .navbar-nav .nav-item .nav-link').on('click', function(){
		$('.allison-aside').toggleClass('active-allison-aside');
